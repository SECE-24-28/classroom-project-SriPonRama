  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-100 dark:bg-gray-900 pb-24">
      ...
      <div className="container mx-auto px-4 py-8">
          ...
          {transactions.length > 0 && (
            <div className="flex gap-4">
              ...
              <button
                ...
                className="px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-lg font-medium transition-all duration-200"
              >
                Download CSV
              </button>
            </div>
        ...
        {transactions.length === 0 ? (
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-100 p-12 text-center">
            <p className="text-xl text-gray-800 dark:text-gray-400">No transactions yet</p>
          </div>
        ) : (
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-100 overflow-hidden">
