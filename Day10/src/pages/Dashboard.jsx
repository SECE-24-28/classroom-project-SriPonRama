    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-100 dark:bg-gray-900 pb-24">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Link to="/recharge" className="bg-gradient-to-br from-amber-50 to-orange-100 hover:from-amber-100 hover:to-orange-200 text-gray-800 rounded-xl p-8 shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 border border-amber-200">
            <h3 className="text-2xl font-bold mb-2">Recharge Now</h3>
            <p>Quick mobile recharge</p>
          </Link>
          
          <Link to="/plans" className="bg-gradient-to-br from-amber-50 to-orange-100 hover:from-amber-100 hover:to-orange-200 text-gray-800 rounded-xl p-8 shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 border border-amber-200">
            <h3 className="text-2xl font-bold mb-2">Browse Plans</h3>
            <p>All operators & plans</p>
          </Link>
          
          <Link to="/profile" className="bg-gradient-to-br from-amber-50 to-orange-100 hover:from-amber-100 hover:to-orange-200 text-gray-800 rounded-xl p-8 shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 border border-amber-200">
