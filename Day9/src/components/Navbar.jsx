    ...
    <nav className="bg-gradient-to-r from-[#005461] to-[#018790] dark:from-gray-800 dark:to-gray-900 shadow-lg">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-6">
          ...
          <button onClick={toggleTheme} className="px-3 py-2 bg-[#F3E2D4] hover:bg-[#E6D1C1] text-gray-800 rounded font-semibold transition">
            {isDark ? 'Light' : 'Dark'}
          </button>
          <button onClick={handleLogout} className="px-4 py-2 bg-[#F3E2D4] hover:bg-[#E6D1C1] text-gray-800 rounded font-semibold transition">
            Logout
          </button>
        </div>
      </div>
