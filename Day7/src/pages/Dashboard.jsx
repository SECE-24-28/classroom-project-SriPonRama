    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-24">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Link to="/recharge" className="bg-gradient-to-r from-[#005461] to-[#018790] text-white rounded-2xl p-8 hover:shadow-2xl transform hover:scale-105 transition">
            <div className="text-5xl mb-4">📱</div>
            <h3 className="text-2xl font-bold mb-2">Recharge Now</h3>
            <p>Quick mobile recharge</p>
          </Link>
          
          <Link to="/plans" className="bg-gradient-to-r from-[#018790] to-[#00B7B5] text-white rounded-2xl p-8 hover:shadow-2xl transform hover:scale-105 transition">
            <div className="text-5xl mb-4">🎯</div>
            <h3 className="text-2xl font-bold mb-2">Browse Plans</h3>
            <p>All operators & plans</p>
          </Link>
          
          <Link to="/profile" className="bg-gradient-to-r from-[#00B7B5] to-[#018790] text-white rounded-2xl p-8 hover:shadow-2xl transform hover:scale-105 transition">
            <div className="text-5xl mb-4">👤</div>
