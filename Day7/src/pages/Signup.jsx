...
const Signup = () => {
  const [formData, setFormData] = useState({ name: '', email: '', password: '', mobile: '', operator: 'Airtel' });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#018790] to-[#00B7B5] flex items-center justify-center px-4 py-8">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 w-full max-w-md">
        ...
        <p className="text-center text-gray-600 dark:text-gray-400 mt-6">
          Already have an account? <Link to="/login" className="text-[#005461] dark:text-[#00B7B5] font-semibold">Login</Link>
        </p>
      </div>
    </div>
  );
